 ...
 */
- (void)showDialogWithMessage:(NSString*)message title:(NSString*)title buttons:(NSArray*)buttons defaultText:(NSString*)defaultText callbackId:(NSString*)callbackId dialogType:(NSString*)dialogType addDestructiveButtonWithLabel:(NSString*) addDestructiveButtonWithLabel
{
    ...
    if (NSClassFromString(@"UIAlertController")) {
        ...
        for (int n = 0; n < count; n++) {
            int buttonStyle;
            NSString *button = [buttons objectAtIndex:n];
            if (button == addDestructiveButtonWithLabel){
...
- (void)alert:(CDVInvokedUrlCommand*)command
{
    ...
    NSString* addDestructiveButtonWithLabel = [command argumentAtIndex:3];

    [self showDialogWithMessage:message title:title buttons:@[buttons] defaultText:nil callbackId:callbackId dialogType:DIALOG_TYPE_ALERT addDestructiveButtonWithLabel:addDestructiveButtonWithLabel];
}
...
- (void)prompt:(CDVInvokedUrlCommand*)command
{
    ...
    NSString* addDestructiveButtonWithLabel = [command argumentAtIndex:4];

    [self showDialogWithMessage:message title:title buttons:buttons defaultText:defaultText callbackId:callbackId dialogType:DIALOG_TYPE_PROMPT addDestructiveButtonWithLabel:addDestructiveButtonWithLabel];
}
