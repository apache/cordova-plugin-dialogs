 ...
 */
- (void)showDialogWithMessage:(NSString*)message title:(NSString*)title buttons:(NSArray*)buttons defaultText:(NSString*)defaultText isSecureInput:(BOOL)isSecureInput callbackId:(NSString*)callbackId dialogType:(NSString*)dialogType
{
    ...
    if (NSClassFromString(@"UIAlertController")) {
        ...
        if ([dialogType isEqualToString:DIALOG_TYPE_PROMPT]) {
            ...
            [alertController addTextFieldWithConfigurationHandler:^(UITextField *textField) {
                ...
                textField.secureTextEntry = isSecureInput;
            }];
        }
    ...
    else
    {
        ...
        if ([dialogType isEqualToString:DIALOG_TYPE_PROMPT]) {
            alertView.alertViewStyle = isSecureInput ? UIAlertViewStyleSecureTextInput : UIAlertViewStylePlainTextInput;
...
- (void)alert:(CDVInvokedUrlCommand*)command
{
    ...
    [self showDialogWithMessage:message title:title buttons:@[buttons] defaultText:nil isSecureInput:NO callbackId:callbackId dialogType:DIALOG_TYPE_ALERT];
}
...
- (void)prompt:(CDVInvokedUrlCommand*)command
{
    ...
    [self showDialogWithMessage:message title:title buttons:buttons defaultText:defaultText isSecureInput:NO callbackId:callbackId dialogType:DIALOG_TYPE_PROMPT];
}

- (void)promptPassword:(CDVInvokedUrlCommand*)command
{
    NSString* callbackId = command.callbackId;
    NSString* message = [command argumentAtIndex:0];
    NSString* title = [command argumentAtIndex:1];
    ...
    [self showDialogWithMessage:message title:title buttons:buttons defaultText:defaultText isSecureInput:YES callbackId:callbackId dialogType:DIALOG_TYPE_PROMPT];
}
